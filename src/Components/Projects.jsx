  ...
  return (
    ...
    <div className="container projects" id="projects">
      ...
      <div className="row">
        ...
        <div className="card bg-dark text-light" style={{width:'18rem', border:'1px solid yellow', boxShadow:'5px 5px 10px 0px rgba(101, 175, 10)'}} data-aos="flip-right" data-aos-duration="1000">
